...
std::pair<TGraphErrors*,TGraphErrors*> FillPlot(const string & plotname, const string& layer, const vector<string> &sample, int colour, const string&  y_title, bool runNo,int method = 1);
